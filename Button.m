...
- (id)initWithName:(NSString *)buttonName offset:(int)offset X:(CGFloat)X Y:(CGFloat)Y {
    ...
    return [self initWithNameAndScale:buttonName offset:offset X:X Y:Y scale:1];
}

- (id)initWithNameAndScale:(NSString *)buttonName offset:(int)offset X:(CGFloat)X Y:(CGFloat)Y scale:(float)scale {
